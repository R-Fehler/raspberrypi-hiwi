...
wiringpi.pinMode(PWM_PIN,PWM_MODE)
...
while(1):
	if(ser.inWaiting() != 0):
		...
		if(len(data)!=0):
			...
			#print data
			print datadez
			#datadez = [35, 18, 1, 12, 69, 251, 131, 1, 0, 71, 2, 41, 35, 18, 1, 12, 69, 248, 207, 2, 0, 70, 2, 41, 35, 18, 2, 12, 70, 172, 166, 2, 0, 72, 2, 39, 35, 18, 3, 12, 70, 172, 166, 2, 0, 72, 2, 39, 35, 18, 2, 12, 69, 251, 131, 1, 0, 71, 2, 37] 
			idpostuplelist = filterid(datadez)
			print idpostuplelist
